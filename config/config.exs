...
config :rocketpay, RocketpayWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "kAqkeqI4DJeHlYuATPSXsUpNcgEWZVQiWOogzZ1MJY06ROxvi23ZdUEHhbLZnY9R",
  render_errors: [view: RocketpayWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Rocketpay.PubSub,
  live_view: [signing_salt: "CHyu4rVW"]

# Every migration will use binary_id (UUID)
